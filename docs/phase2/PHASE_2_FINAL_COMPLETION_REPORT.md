...
| `whatsapp_sessions` | Map phone numbers to WhatsApp sessions | 12 |
...
| POST | `/api/v1/devices/:id/heartbeat` | Launcher heartbeat | API Key |
...
| POST | `/api/v1/phone-numbers/:id/whatsapp/confirm-link` | Confirm link | API Key |
| POST | `/api/v1/phone-numbers/:id/whatsapp/status-update` | Status update | API Key |
...
| POST | `/api/v1/launcher/whatsapp-launch` | Launch session | API Key |
| POST | `/api/v1/launcher/whatsapp-confirm` | Confirm link | API Key |
| POST | `/api/v1/launcher/whatsapp-status` | Report status | API Key |
...
| `WhatsAppActions` | Action buttons based on status |
| `StatusBadge` | Color-coded status indicator |
| `SessionSetupDialog` | QR code setup flow |
...
| Credential Hashing | Argon2id | ✅ Tested |
