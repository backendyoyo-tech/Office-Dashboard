...
|-------|------------|---------|
| Frontend | Vite + React 18, Tailwind CSS | User interface for managing phones and WhatsApp sessions |
| API Server | Express.js, TypeScript | REST API for all operations |
| Database | PostgreSQL (via Prisma ORM) | Persistent storage with application-level tenant scoping |
...
│                                                                  │
│  Layer 3: Service Layer (Prisma ORM)                              │
│  ├── Backend API uses Prisma service role                        │
...
|-----------|------------|---------|---------|
| Frontend | Vite + React | 18 | React framework |
...
Custom Server
├── Vite built static assets (port 3001)
