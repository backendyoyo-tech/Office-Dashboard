...
4. Run `python main.py` (or install as service)
...
**A:** Stop the launcher, replace main.py with new version, update dependencies if needed, and restart.
...
| Command | Purpose |
|---------|---------|
| `python main.py --test` | Test launcher connection |
| `python main.py` | Start launcher |
...
|------|----------|---------|
| `launcher_config.json` | `C:\HairRap\` | Launcher configuration |
...
- [ ] `launcher_config.json` configured
