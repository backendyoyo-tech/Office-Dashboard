...
router.post('/platform-capability', launcherAuth, (req, res, next) => launcherController.platformCapability(req, res, next));
router.post('/platform-consume', launcherAuth, (req, res, next) => launcherController.platformConsume(req, res, next));
router.post('/platform-ack', launcherAuth, (req, res, next) => launcherController.platformAck(req, res, next));
